...
const ART_ICONS={
  'borse':'bag','borsa':'bag','portafogli':'wallet','portafoglio':'wallet','cinture':'belt','cintura':'belt','scarpe':'shoe','scarpa':'shoe',
  'gioielli':'jewel','orologi':'watch','occhiali':'glasses','accessori':'spark'
};
...
function brandLogoDataUri(brand){
  ...
  const h1=seed%360;
  const h2=(seed+28)%360;
  const svg=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 96 96">
    <defs>
      <linearGradient id="g" x1="0" y1="0" x2="1" y2="1">
        <stop offset="0%" stop-color="hsl(${h1},90%,92%)"/>
        <stop offset="100%" stop-color="hsl(${h2},88%,82%)"/>
      </linearGradient>
    </defs>
    <rect width="96" height="96" rx="22" fill="#fffef9"/>
    <rect x="6" y="6" width="84" height="84" rx="20" fill="url(#g)" stroke="rgba(15,23,42,.12)"/>
    <ellipse cx="48" cy="76" rx="26" ry="8" fill="rgba(15,23,42,.08)"/>
    <path d="M20 55c0-18 13-31 28-31 9 0 15 3 19 8 4-2 8-3 13-3 6 0 9 4 9 9 0 10-11 17-18 20l-6 20H33l-4-16c-6-1-9-3-9-7z" fill="rgba(255,255,255,.88)" stroke="rgba(15,23,42,.14)" stroke-width="1.4"/>
    <circle cx="29" cy="28" r="6" fill="rgba(255,255,255,.65)"/>
    <circle cx="70" cy="22" r="4" fill="rgba(255,255,255,.52)"/>
    <text x="48" y="57" text-anchor="middle" font-family="Arial, sans-serif" font-size="28" font-weight="900" fill="#18212f">${initials}</text>
    <path d="M34 64h28" stroke="#18212f" stroke-width="2" stroke-linecap="round" opacity=".25"/>
  </svg>`;
...
function categoryClipArtDataUri(cat){
  ...
  const h1=seed%360;
  const h2=(seed+34)%360;
  const top=`hsl(${h1},92%,92%)`;
  const bottom=`hsl(${h2},88%,82%)`;
  let art='';
  if(token==='bag') art='<path d="M24 38h48l-4 30H28z" fill="#f8fbff" stroke="#243244" stroke-width="2.4"/><path d="M36 40c0-9 5-14 12-14s12 5 12 14" fill="none" stroke="#243244" stroke-width="2.6" stroke-linecap="round"/><circle cx="38" cy="52" r="3" fill="#243244"/><circle cx="58" cy="52" r="3" fill="#243244"/><path d="M30 60c8 7 27 7 36 0" fill="none" stroke="#243244" stroke-width="2.4" stroke-linecap="round"/>'; 
  else if(token==='wallet') art='<rect x="20" y="30" width="56" height="36" rx="10" fill="#fffdf8" stroke="#243244" stroke-width="2.4"/><path d="M20 42h36c6 0 10 4 10 10v14" fill="none" stroke="#243244" stroke-width="2.2"/><circle cx="58" cy="48" r="3.2" fill="#243244"/><path d="M26 56h18" stroke="#243244" stroke-width="2.4" stroke-linecap="round"/>'; 
  else if(token==='belt') art='<path d="M18 50h46" stroke="#243244" stroke-width="10" stroke-linecap="round"/><rect x="54" y="43" width="18" height="14" rx="3" fill="#fffdf8" stroke="#243244" stroke-width="2.4"/><path d="M72 50h8" stroke="#243244" stroke-width="6" stroke-linecap="round"/><circle cx="61" cy="50" r="2.8" fill="#243244"/>'; 
  else if(token==='shoe') art='<path d="M22 58c8 0 13-5 18-14 3 5 8 10 16 12 6 2 12 2 18 2v6H22z" fill="#fffdf8" stroke="#243244" stroke-width="2.4"/><path d="M37 51c3 2 7 4 11 5" stroke="#243244" stroke-width="2.1" stroke-linecap="round"/><path d="M28 58h42" stroke="#243244" stroke-width="2.2" stroke-linecap="round"/>'; 
  else if(token==='jewel') art='<path d="M48 24l16 10-16 38-16-38z" fill="#fffdf8" stroke="#243244" stroke-width="2.4"/><path d="M32 34h32" stroke="#243244" stroke-width="2.2"/><path d="M40 29l8 8 8-8" fill="none" stroke="#243244" stroke-width="2.2"/>'; 
  else if(token==='watch') art='<rect x="36" y="18" width="24" height="60" rx="10" fill="rgba(255,255,255,.7)"/><rect x="28" y="28" width="40" height="40" rx="12" fill="#fffdf8" stroke="#243244" stroke-width="2.4"/><circle cx="48" cy="48" r="12" fill="none" stroke="#243244" stroke-width="2.2"/><path d="M48 48l7-5" stroke="#243244" stroke-width="2.2" stroke-linecap="round"/><path d="M48 48v-8" stroke="#243244" stroke-width="2.2" stroke-linecap="round"/>'; 
  else if(token==='glasses') art='<path d="M18 46h12" stroke="#243244" stroke-width="2.4"/><path d="M66 46h12" stroke="#243244" stroke-width="2.4"/><rect x="24" y="38" width="20" height="16" rx="6" fill="#fffdf8" stroke="#243244" stroke-width="2.4"/><rect x="52" y="38" width="20" height="16" rx="6" fill="#fffdf8" stroke="#243244" stroke-width="2.4"/><path d="M44 46h8" stroke="#243244" stroke-width="2.4"/>'; 
  else art='<path d="M48 22l6 12 14 2-10 10 2 14-12-7-12 7 2-14-10-10 14-2z" fill="#fffdf8" stroke="#243244" stroke-width="2.4"/>';
  const svg=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 96 96">
    <defs>
      <linearGradient id="g" x1="0" y1="0" x2="1" y2="1">
    ...
    <rect width="96" height="96" rx="22" fill="#fffef9"/>
    <rect x="6" y="6" width="84" height="84" rx="20" fill="url(#g)" stroke="rgba(15,23,42,.12)"/>
    <ellipse cx="48" cy="76" rx="24" ry="7" fill="rgba(15,23,42,.08)"/>
    <circle cx="24" cy="24" r="5" fill="rgba(255,255,255,.58)"/>
    <circle cx="72" cy="22" r="3.5" fill="rgba(255,255,255,.45)"/>
    ${art}
  </svg>`;
  return svgDataUri(svg);
}
